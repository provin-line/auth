...
/**
 * Thrown by `generatePolicyVerifierScaffold` when the output directory exists
 ...
 *
 * `--force` is deferred (see create-app.md § 4.3) — when added, it should resolve via
 * a flag on `GenerateOptions`, not by suppressing this error.
 */
